% bc-crypto-base(SECTION) | User Commands
%
% "January 29 2023"
...
bc-crypto-base - program to do something

# SYNOPSIS

**bc-crypto-base** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**bc-crypto-base** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **bc-crypto-base** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**bc-crypto-base** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    bc-crypto-base. See **foo.conf**(5) for further details.
...
**bc-crypto-base** provides some return codes, that can be used in scripts:
